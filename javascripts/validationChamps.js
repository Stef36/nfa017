...
function remFunc(){
  ...
  $attention=1;
	...
	$erreur.style.color= "red";
	$erreur.innerHTML= ('merci de formuler au moins 3 caractères...SVP. ' );
	$attention=1;
	}
...
function valider() {
 ...
 //alert ('dans valider()'+ $entreeNom);
   ...
   return false;
	...
	else if ($x != $addition ){// la variable globale $addition est définie  à kapcha.js
		alert ('Kapcha fausse.');
		document.preInscription.kapcharep.focus();
   return false;
   }
